...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            valid_words = sum([1 for word in words if word in self.valid_words])
...
if __name__ == "__main__":
    ...
    #
    plaintext = PlaintextMessage("abc", 28)
    ...
    print("Expected Output: (shift value that decrypts to 'Hello, World!')")
    print("Actual Output:", ciphertext.decrypt_message())
